    ...
    async execute({ api, args, message, event }) {
        ...
        try {
            ...
            if (participantIDs.includes(userID)) {
                ...
                api.sendMessage(
                    "✿━━━━━━━━━━━━━━━━✿\n⚠️ أنت بالفعل في مجموعة شادو البوت. إذا لم تجده، يرجى التحقق من طلبات الرسائل أو صندوق الرسائل غير المرغوب فيها.\n✿━━━━━━━━━━━━━━━━✿",
                    threadID
                );
            } else {
                ...
                api.addUserToGroup(userID, supportGroupId, (err) => {
                    if (err) {
                        ...
                        console.error("✿━━━━━━━━━━━━━━━━✿\n❌ فشل إضافتك إلى مجموعة شادو\n✿━━━━━━━━━━━━━━━✿", err);
                        api.sendMessage("✿━━━━━━━━━━━━━━━━✿\n❌ لا أستطيع إضافتك لأن هويتك غير مسموح بها لطلب الرسائل أو أن حسابك خاص. الرجاء إضافتي ثم حاول مرة أخرى...\n✿━━━━━━━━━━━━━━━━✿", threadID);
                    } else {
                        api.setMessageReaction("✅", event.messageID, (err) => {}, true);
                        api.sendMessage(
                            "✿━━━━━━━━━━━━━━━━✿\n✅ لقد تمت إضافتك إلى مجموعة شادو البوت. إذا لم تجد الصندوق في صندوق الوارد الخاص بك، فيرجى التحقق من طلبات الرسائل أو صندوق البريد العشوائي.\n✿━━━━━━━━━━━━━━━✿",
                            threadID
                        );
                    }
                });
